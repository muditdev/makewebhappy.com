...
date: '2021-04-25T13:32:06.592Z'
tags: ['react', 'guide', 'vite', 'eslint', 'airbnb', 'prettier']
draft: false
images: ['/static/images/Reactjs-vite-airbnb.jpeg']
summary: 'A simple guide to setup react js project with vite 2, eslint and airbnb goodness.'
authors: ['default']
---

![banner](/static/images/Reactjs-vite-airbnb.jpeg)
...
Here is the github repo you can clone and start coding
